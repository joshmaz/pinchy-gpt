...
A living catalog of external pinball resources Pinchy‑GPT can reference.
Keep this document current; the prompt will include a *Routing Rules* summary derived from here.
